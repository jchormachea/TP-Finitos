...
%caso 1 es la estructura optimizada que verifica
%caso 2 es la estrucutra orginal
...
for iElement = 1:nElements
    bendingStress = 0; % se usa para seccion circular
    bendingStressy = 0; %se usa para cuadrada
    bendingStressz = 0; %se usa para cuadrada
